            ...
            <ContentWrapper>
                <div className="content-heading">
                    ...
                    <div className="pull-right">
                        <Dropdown id="dropdown-tr" pullLeft>
                            <Dropdown.Toggle>
                                English
                            </Dropdown.Toggle>
                            <Dropdown.Menu className="animated fadeInUpShort">
                                ...
                                <MenuItem eventKey="3" data-set-lang="es">Chinese</MenuItem>
                                <MenuItem eventKey="4" data-set-lang="es">Dutch</MenuItem>
                            </Dropdown.Menu>
                        </Dropdown>
                    </div>
